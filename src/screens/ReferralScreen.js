...
const styles = StyleSheet.create({
  ...
  cardLabel: { color: '#555', fontSize: 12, fontFamily: 'Iceland_400Regular', lineHeight: 17, letterSpacing: 1, marginBottom: 10 },
  ...
  code: { color: '#22c55e', fontSize: 22, fontFamily: 'Iceland_400Regular', lineHeight: 32, letterSpacing: 4 },
  copyBtn: { color: '#22c55e', fontSize: 13, fontFamily: 'Iceland_400Regular', lineHeight: 19, borderWidth: 1, borderColor: '#22c55e44', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 6 },
  hint: { color: '#555', fontSize: 13, fontFamily: 'Iceland_400Regular', lineHeight: 19 },
  ...
  statValue: { color: '#fff', fontSize: 20, fontFamily: 'Iceland_400Regular', lineHeight: 29, marginBottom: 4 },
  statLabel: { color: '#555', fontSize: 12, fontFamily: 'Iceland_400Regular', lineHeight: 17 },
  inputRow: { flexDirection: 'row', gap: 8, marginTop: 10 },
  input: { flex: 1, backgroundColor: '#111', borderWidth: 1, borderColor: '#222', borderRadius: 8, color: '#fff', padding: 12, fontFamily: 'Iceland_400Regular', lineHeight: 20, fontSize: 14 },
  applyBtn: { backgroundColor: '#22c55e', borderRadius: 8, paddingHorizontal: 18, alignItems: 'center', justifyContent: 'center' },
  applyText: { color: '#000', fontWeight: '700', fontSize: 14, fontFamily: 'Iceland_400Regular', lineHeight: 20 },
  referredBy: { color: '#666', fontSize: 12, fontFamily: 'Iceland_400Regular', lineHeight: 17, marginTop: 4 },
});
