...
const styles = StyleSheet.create({
  ...
  priceText: { color: '#fff', fontSize: 18, fontFamily: 'Iceland_400Regular', lineHeight: 26 },
  currencyBadge: { color: '#22c55e', fontSize: 13 },
  sideBadge: { fontSize: 14, fontWeight: '700', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 4 },
  sellBadge: { backgroundColor: '#7f1d1d', color: '#fca5a5' },
  orderMeta: { color: '#666', fontSize: 14, fontFamily: 'Iceland_400Regular', lineHeight: 20 },
  makerText: { color: '#555', fontSize: 14, fontFamily: 'Iceland_400Regular', lineHeight: 20 },
  methodsRow: { flexDirection: 'row', flexWrap: 'wrap', marginTop: 6, gap: 4 },
  methodTag: { borderRadius: 4, backgroundColor: '#1a1a1a', color: '#777', fontSize: 13, paddingHorizontal: 6, paddingVertical: 2, borderWidth: 1, borderColor: '#333' },
  ...
  postBtnText: { color: '#000', fontWeight: '700', fontSize: 15, fontFamily: 'Iceland_400Regular', lineHeight: 22 },
});
