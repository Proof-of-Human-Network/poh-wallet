...
const styles = StyleSheet.create({
  ...
  title: { color: '#fff', fontSize: 17, fontFamily: 'Iceland_400Regular', lineHeight: 25 },

  searchRow: { flexDirection: 'row', gap: 6, marginBottom: 8 },
  searchInput: { flex: 1, backgroundColor: '#111', borderWidth: 1, borderColor: '#222', borderRadius: 8, color: '#fff', padding: 10, fontSize: 12, fontFamily: 'Iceland_400Regular', lineHeight: 17 },
  searchBtn: { backgroundColor: '#22c55e', borderRadius: 8, paddingHorizontal: 14, alignItems: 'center', justifyContent: 'center' },
  searchBtnText: { color: '#000', fontWeight: '700', fontSize: 13, fontFamily: 'Iceland_400Regular', lineHeight: 19 },
  ...
  tabText: { color: '#555', fontSize: 11, fontFamily: 'Iceland_400Regular', lineHeight: 16 },
  ...
  blockHeight: { color: '#22c55e', fontSize: 13, fontFamily: 'Iceland_400Regular', lineHeight: 19 },
  blockMeta: { color: '#555', fontSize: 11, fontFamily: 'Iceland_400Regular', lineHeight: 16, marginTop: 2 },
  blockTime: { color: '#374151', fontSize: 10, fontFamily: 'Iceland_400Regular', lineHeight: 15 },
  reward: { color: '#22c55e', fontSize: 11, fontFamily: 'Iceland_400Regular', lineHeight: 16 },
  ...
  pageBtnText: { color: '#888', fontSize: 12, fontFamily: 'Iceland_400Regular', lineHeight: 17 },
  pageNum: { color: '#555', fontSize: 12, fontFamily: 'Iceland_400Regular', lineHeight: 17 },

  card: { backgroundColor: '#0d0d0d', borderRadius: 10, padding: 14, marginBottom: 10, borderWidth: 1, borderColor: '#1a1a1a' },
  cardLabel: { color: '#555', fontSize: 11, fontFamily: 'Iceland_400Regular', lineHeight: 16, letterSpacing: 1, marginBottom: 8 },
  row: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 5 },
  rowLabel: { color: '#555', fontSize: 11, fontFamily: 'Iceland_400Regular', lineHeight: 16 },
  rowValue: { color: '#aaa', fontSize: 11, fontFamily: 'Iceland_400Regular', lineHeight: 16, maxWidth: '65%', textAlign: 'right' },

  txCard: { backgroundColor: '#0a0a0a', borderRadius: 6, padding: 8, marginBottom: 5, borderWidth: 1, borderColor: '#1a1a1a' },
  txHash: { color: '#60a5fa', fontSize: 10, fontFamily: 'Iceland_400Regular', lineHeight: 15, marginBottom: 4 },
  txRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  txAddr: { color: '#555', fontSize: 10, fontFamily: 'Iceland_400Regular', lineHeight: 15 },
  txAmount: { color: '#22c55e', fontSize: 11, fontFamily: 'Iceland_400Regular', lineHeight: 16 },

  sectionLabel: { color: '#555', fontSize: 11, fontFamily: 'Iceland_400Regular', lineHeight: 16, letterSpacing: 1, marginBottom: 5, marginTop: 6 },
  histRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 6, borderBottomWidth: 1, borderBottomColor: '#111' },
  histLabel: { color: '#555', fontSize: 11, fontFamily: 'Iceland_400Regular', lineHeight: 16 },
  histAmt: { fontSize: 12, fontFamily: 'Iceland_400Regular', lineHeight: 17 },

  empty: { color: '#555', textAlign: 'center', marginTop: 40, fontFamily: 'Iceland_400Regular', lineHeight: 20 },
  error: { color: '#ef4444', textAlign: 'center', marginTop: 40, fontFamily: 'Iceland_400Regular', lineHeight: 20 },
});
