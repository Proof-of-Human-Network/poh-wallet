...
const styles = StyleSheet.create({
  ...
  sectionTitle: { color: '#22c55e', fontSize: 16, fontWeight: '600', marginBottom: 8, fontFamily: 'Iceland_400Regular', lineHeight: 23 },

  scanHero: { marginBottom: 8 },
  scanTag: { color: '#22c55e', fontSize: 14, letterSpacing: 2, marginBottom: 4 },
  scanTitle: { color: '#fff', fontSize: 22, fontWeight: '700', fontFamily: 'Iceland_400Regular', lineHeight: 32 },
  ...
  submitText: { color: '#000', fontWeight: '700', fontSize: 16, fontFamily: 'Iceland_400Regular', lineHeight: 23 },
  ...
  vibeLabel: { fontFamily: 'Iceland_400Regular', lineHeight: 22, fontSize: 15, letterSpacing: 1.5, color: '#22c55e' },
  vibeSourcePill: { fontFamily: 'Iceland_400Regular', lineHeight: 22, fontSize: 15, color: '#374151', backgroundColor: '#111', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 8 },
  ...
  vibeTopic: { fontFamily: 'Iceland_400Regular', lineHeight: 19, fontSize: 13, color: '#22c55e', backgroundColor: 'rgba(34,197,94,0.08)', borderWidth: 1, borderColor: 'rgba(34,197,94,0.2)', paddingHorizontal: 8, paddingVertical: 3, borderRadius: 10 },
  ...
  vibeCastMeta: { fontFamily: 'Iceland_400Regular', lineHeight: 22, fontSize: 15, color: '#374151', marginLeft: 8 },
  vibeArticle: { paddingVertical: 3 },
  vibeArticleTitle: { fontFamily: 'Iceland_400Regular', lineHeight: 20, fontSize: 14, color: '#9ca3af' },
  vibeArticleSub: { fontFamily: 'Iceland_400Regular', lineHeight: 19, fontSize: 13, color: '#4b5563' },
  ...
  charTopic: { fontFamily: 'Iceland_400Regular', lineHeight: 19, fontSize: 13, color: '#22c55e', backgroundColor: 'rgba(34,197,94,0.08)', borderWidth: 1, borderColor: 'rgba(34,197,94,0.2)', paddingHorizontal: 8, paddingVertical: 3, borderRadius: 10 },
  ...
  charSourceLabel: { fontFamily: 'Iceland_400Regular', lineHeight: 20, fontSize: 14, color: '#6b7280', fontWeight: '600', marginBottom: 5, flexDirection: 'row', alignItems: 'center' },
  charFollowMeta: { fontFamily: 'Iceland_400Regular', lineHeight: 19, fontSize: 13, color: '#374151' },
  charBio: { fontFamily: 'Iceland_400Regular', lineHeight: 20, fontSize: 14, color: '#6b7280', fontStyle: 'italic', marginBottom: 6 },
  ...
  charCastMeta: { fontFamily: 'Iceland_400Regular', lineHeight: 22, fontSize: 15, color: '#374151', marginLeft: 6 },
  charArticle: { paddingVertical: 3 },
  charArticleTitle: { fontFamily: 'Iceland_400Regular', lineHeight: 20, fontSize: 14, color: '#9ca3af' },
  charArticleSub: { fontFamily: 'Iceland_400Regular', lineHeight: 19, fontSize: 13, color: '#4b5563' },
