...
const styles = StyleSheet.create({
  ...
  newBtn: { color: '#22c55e', fontSize: 14, fontFamily: 'Iceland_400Regular', lineHeight: 20 },
  ...
  tabBtnText: { color: '#888', fontSize: 13, fontFamily: 'Iceland_400Regular', lineHeight: 19 },
  ...
  cardTitle: { color: '#fff', fontSize: 16, fontFamily: 'Iceland_400Regular', lineHeight: 23, marginBottom: 4 },
  cardMeta: { color: '#666', fontSize: 14, fontFamily: 'Iceland_400Regular', lineHeight: 20, marginBottom: 2 },
  badge: { fontSize: 13, fontWeight: '700', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4 },
  ...
  detailBtnText: { color: '#aaa', fontSize: 15, fontFamily: 'Iceland_400Regular', lineHeight: 22 },
  cancelBtn: { borderRadius: 6, borderWidth: 1, borderColor: '#dc262633', paddingHorizontal: 12, paddingVertical: 6 },
  cancelBtnText: { color: '#dc2626', fontSize: 15, fontFamily: 'Iceland_400Regular', lineHeight: 22 },

  emptyText: { color: '#555', textAlign: 'center', marginTop: 60, fontFamily: 'Iceland_400Regular', lineHeight: 20 },
});
