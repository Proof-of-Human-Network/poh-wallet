...
const styles = StyleSheet.create({
  ...
  cardMeta: { color: '#666', fontSize: 14, fontFamily: 'Iceland_400Regular', marginBottom: 2 },
  ...
  detailBtnText: { color: '#aaa', fontSize: 15, fontFamily: 'Iceland_400Regular' },
  cancelBtn: { borderRadius: 6, borderWidth: 1, borderColor: '#dc262633', paddingHorizontal: 12, paddingVertical: 6 },
  cancelBtnText: { color: '#dc2626', fontSize: 15, fontFamily: 'Iceland_400Regular' },
